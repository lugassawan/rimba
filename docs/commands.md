...
<div class="rimba-features">
  ...
  <a class="rimba-feature" href="{{ '/commands/report' | relative_url }}">
    <span class="rimba-feature-title">rimba report</span>
    <p>Aggregate observability timing metrics into a report for filing issues</p>
  </a>
